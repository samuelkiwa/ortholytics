...
# softwares
our $BLASTALL                            = "/usr/local/bin/blastall";
our $FORMATDB                            = "/usr/local/bin/formatdb";
our $MCL                                 = "/usr/local/bin/mcl";

# path
our $PATH_TO_ORTHOMCL                    = "/data/9_opl/orthomcl/";   # must end with "/" 
...
our $PERCENT_IDENTITY_CUTOFF_DEFAULT     = 0;
our $PERCENT_MATCH_CUTOFF_DEFAULT        = 0;
